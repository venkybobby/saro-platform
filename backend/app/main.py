"""SARO Platform v5.0 - AI Regulatory Intelligence"""
...
from app.api import (
    ...
    personas, policies, audit_reports
)

app = FastAPI(title="SARO Platform API", version="5.0.0", docs_url="/api/docs", redoc_url="/api/redoc")
...
@app.get("/")
async def root():
    return {"platform": "SARO - AI Regulatory Intelligence", "version": "5.0.0", "status": "operational", "total_tests": 943, "docs": "/api/docs"}
