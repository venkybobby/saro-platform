"""SARO Platform v5.2 — AI Regulatory Intelligence"""
...
app = FastAPI(title="SARO Platform API", version="5.2.0", docs_url="/api/docs", redoc_url="/api/redoc")
...
@app.get("/")
async def root():
    return {"platform": "SARO", "version": "5.2.0", "status": "operational", "docs": "/api/docs"}

@app.get("/health")
async def health_root():
    return {"status": "healthy", "version": "5.2.0"}
